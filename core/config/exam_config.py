...
class GMATConfig(BaseExamConfig):
    ...
    def from_dict(cls, config_dict: Dict[str, Any]) -> 'GMATConfig':
        ...
        return cls(
            ...
            include_integrated_reasoning=config_dict.get(
                'include_integrated_reasoning', True),
            quant_questions_per_section=config_dict.get(
                'quant_questions_per_section', 31),
            verbal_questions_per_section=config_dict.get(
                'verbal_questions_per_section', 36),
            ir_questions_per_section=config_dict.get(
                'ir_questions_per_section', 12),
...
class GREConfig(BaseExamConfig):
    ...
    def from_dict(cls, config_dict: Dict[str, Any]) -> 'GREConfig':
        ...
        return cls(
            ...
            timeout_seconds=config_dict.get('timeout_seconds', 300),
            quant_questions_per_section=config_dict.get(
                'quant_questions_per_section', 20),
            verbal_questions_per_section=config_dict.get(
                'verbal_questions_per_section', 20),
