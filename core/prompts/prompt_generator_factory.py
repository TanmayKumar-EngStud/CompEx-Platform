...
class PromptGeneratorFactory:
    ...
    def _register_generators(self):
        ...
        try:
            ...
            self._generators[(ExamType.GMAT, SectionType.QUANTITATIVE)] = GMATQuantsPrompts
            self._generators[(ExamType.GMAT, SectionType.VERBAL)] = GMATVerbalPrompts
            self._generators[(ExamType.GMAT, SectionType.INTEGRATED_REASONING)] = GMATIRPrompts
        ...
        try:
            ...
            self._generators[(ExamType.GRE, SectionType.QUANTITATIVE)] = GREQuantsPrompts
            self._generators[(ExamType.GRE, SectionType.VERBAL)] = GREVerbalPrompts
    ...
    def create_prompt_generator(
        ...
        if generator_key not in self._generators:
            ...
            generator_class = self._create_default_generator(exam_type, section_type)
            if generator_class:
    ...
    def _create_default_generator(
        ...
        class DefaultPromptGenerator(BasePromptGenerator):
            ...
            def generate_question_prompts(self) -> list[str]:
                ...
                question_styles = self.component_allocation.get("question_style", ["S"])
                topics = self.component_allocation.get("options", ["general"])
                ...
                for i in range(self.total_questions):
                    ...
                    skills = topic_config.get("focused_skill", ["general"])
