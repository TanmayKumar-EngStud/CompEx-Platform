    ...
    def generate_questionOptions(self):
        def _generate(warn=False):
            ...
            try:
                ...
                log_detailed_error("GMAT Quants SimpleQuestion generate_questionOptions - Exception during parsing", response, str(e), 
...
class DataSufficiencyQuestion:
    ...
    def generate_questionText(self):
        ...
        result_message_question_passage, result_statements, result_question = result
