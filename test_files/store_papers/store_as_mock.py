...
def store_mock_papers():
    paper_dir = os.path.join(project_root, 'log_json_files', 'paper')
    ...
    pattern = re.compile(r'(GRE|GMAT)_new_\d+\.json')
    ...
    for filename in files:
        if pattern.match(filename):
            ...
            try:
                ...
                save_paper_to_db(paper_data, is_mock=True, difficulty=2)
                print(f"  -> Done.")
